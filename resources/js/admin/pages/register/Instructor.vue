        ...
        >
                ...
                >
                    ...
                    >
                        <v-col>
                            ...
                            <p class="grey--text text--lighten-4 headline mt-3 font-weight-black">Sign up and be part of our growing team.</p>
                            <div class="instructor__bg"></div>
                        </v-col>
                    </v-row>
                </v-container>
            </v-col>
            ...
            >
                ...
                >
                    ...
                    >
                        <v-col>
                            <p class="baloo text-h4 mb-5">Sign Up as Instructor</p>
                            <v-btn
                                block
                                outlined
                                x-large
                            ...
                            <h3 class="line-between mb-4">OR</h3>
                            <v-form
                                ref="form"
                                v-model="valid"
                                lazy-validation
